...
class CheckBoxes extends Component
{
     ...
     * @return void
     */
    public function __construct(string $name, array $checkableOptions)
    {
        $this->name = $name;
        $this->checkableOptions = $checkableOptions;
    }
    ...
    {
        return view('components.inputs.check-boxes');
    }
}
