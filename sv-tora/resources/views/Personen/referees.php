...
<head>
    ...
    <title>SV-Tora - Kampfrichter</title>
...
<body class="darkmode">
    ...
    <main class="table-content">
        <a class="button2 add-button tournament-button" href="#"><i class="material-icons">add</i>Kampfrichter hinzufügen</a>
        ...
        <form class="" action="#" method="post">
            <div class="row">
                <span class="input-container text-input-container">
                    <label for="referee-name"><i class="material-icons">person</i></label>
                    <input data-column="Name" class="text-input" type="text" id="referee-name" name="referee-name" placeholder="Name" />
                    <span class="underline"></span>
                </span>
            </div>
            <div class="row">
                <span class="input-container text-input-container">
                    <label for="referee-pre-name"><i class="material-icons">person</i></label>
                    <input data-column="Vorname" class="text-input" type="text" id="referee-pre-name" name="referee-pre-name" placeholder="Vorname" />
                    <span class="underline"></span>
                </span>
            </div>
