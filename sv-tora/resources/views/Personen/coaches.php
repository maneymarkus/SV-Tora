...
<body class="darkmode">
    ...
    <main class="table-content">
        <a class="button2 add-button tournament-button" href="#"><i class="material-icons">add</i>Coach hinzufügen</a>
        ...
        <form class="" action="#" method="post">
            <div class="row">
                <span class="input-container text-input-container">
                    <label for="coach-name"><i class="material-icons">person</i></label>
                    <input data-column="Name" class="text-input" type="text" id="coach-name" name="coach-name" placeholder="Name" />
                    <span class="underline"></span>
                </span>
            </div>
            <div class="row">
                <span class="input-container text-input-container">
                    <label for="coach-pre-name"><i class="material-icons">person</i></label>
                    <input data-column="Vorname" class="text-input" type="text" id="coach-pre-name" name="coach-pre-name" placeholder="Vorname" />
                    <span class="underline"></span>
                </span>
            </div>
