...
<body class="darkmode">
    ...
    <h1 class="align-center">Personen</h1>

    <main class="main-persons clearfix">
        <a href="/SV-Tora/Structure/Personen/starter.php" class="person-group button1">
            <h3>Starter</h3>
        </a>

        <a href="/SV-Tora/Structure/Personen/coaches.php" class="person-group button1">
            <h3>Coaches</h3>
        </a>

        <a href="/SV-Tora/Structure/Personen/referees.php" class="person-group button1">
            <h3>Kampfrichter</h3>
        </a>

        <a href="/SV-Tora/Structure/Personen/helper.php" class="person-group button1">
            <h3>Helpher</h3>
        </a>
    </main>
