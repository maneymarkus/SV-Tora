...
(function (window, document, undefined) {
    ...
    function createTournamentModalContent(tournament, date, time, enrollmentStart, enrollmentEnd, place) {
        ...
        let tournamentSelect = MaterialInputsModule.createInput(inputTypes.SELECT, ["required", "tournament-name"], undefined, "tournament", "Wettkampf", undefined, undefined, allTournaments);
        let dateInput = MaterialInputsModule.createInput(inputTypes.DATE, ["required", "date"], undefined, "date", "Datum", undefined, undefined, undefined);
        let timeInput = MaterialInputsModule.createInput(inputTypes.TIME, ["required"], undefined, "time", "Uhrzeit", undefined, undefined, undefined);
        let startDateInput = MaterialInputsModule.createInput(inputTypes.DATE, ["required", "enrollment-start"], undefined, "enrollment-start", "Start", undefined, undefined, undefined);
        let endDateInput = MaterialInputsModule.createInput(inputTypes.DATE, ["required", "enrollment-end"], undefined, "enrollment-end", "Ende", undefined, undefined, undefined);
        let placeInput = MaterialInputsModule.createInput(inputTypes.TEXT, ["required"], undefined, "place", "Ort", undefined, undefined, undefined);
        ...
        container.appendChild(GeneralModule.generateElement("h2", [], "Anmeldezeitraum"));
        container.appendChild(startDateInput.inputContainer);
        container.appendChild(endDateInput.inputContainer);
        container.appendChild(GeneralModule.generateElement("h2", [], "Veranstaltungsort"));
        container.appendChild(placeInput.inputContainer);

        App.FormModule.checkTime(startDateInput.inputContainer, endDateInput.inputContainer);
    ...
    function checkTournamentModalContent(content) {
        ...
        let dateInputObject = MaterialInputsModule.getInputObject(dateInput);
        let enrollmentEndInputObject = MaterialInputsModule.getInputObject(enrollmentEndInput);
        let date = dateInputObject.getValue();
        let enrollmentEndDate = enrollmentEndInputObject.getValue();
        if (!MaterialInputsModule.compareDates(enrollmentEndDate, date)) {
    ...
    function createTournament(content) {
        ...
        ModalModule.infoModal("Veranstalte Wettkampf!", tournamentObject);
    }
    ...
    if (document.querySelector("main.tournament")) {
        ...
        function completeTournament() {
            ModalModule.infoModal("Wettkampf erfolgreich abgeschlossen", "Ich hoffe, ihr habt den Wettkampf ebenfalls erfolgreich abgeschlossen. Ich bin nun jedenfalls damit durch und will nichts mehr damit zu tun haben.", function () {
        ...
        function deleteTournament() {
            ...
            ModalModule.deleteModal("Wettkampf absagen", "Willst du den Wettkampf wirklich absagen? Diese Aktion kann nicht rückgängig gemacht werden.", function () {
                ...
                ModalModule.confirmModal("Wettkampf absagen", "Willst du den schon angemeldeten Vereinen eine Absagenotiz schicken?", function () {
                    // TODO: go to Mail page and insert enrolled clubs
                    ModalModule.infoModal("Wettkampf Absage", "Okay, eigentlich würdest du jetzt an der Mail schreiben, aber das funktioniert so noch nicht. Sorry :)")
                });
            });
        }
        ...
        function changeStatusOfTournament() {
            ...
            let select = MaterialInputsModule.createInput(GeneralModule.generalVariables.inputTypes.SELECT, undefined, undefined, "tournament-status", "Wettkampf-Status", undefined, undefined, statuus);
            ModalModule.confirmModal("Wettkampf Status ändern", select.inputContainer, function () {
        ...
        function changeTournament() {
            ...
            ModalModule.confirmModal("Wettkampf ändern", content, function () {
        ...
        function handleChangedTournament(content) {
            ...
            if (changedTournamentType) {
                ...
                ModalModule.confirmModal("Wettkampf Änderungen", "Willst du die schon angemeldeten Vereine über die Änderungen informieren?", function () {
                    ModalModule.infoModal("Änderungen publizieren", "Jetzt kannst du eigentlich die Mail an die Vereine schicken. Eigentlich.");
                });
            }
        }
        ...
        function activateWarning(e) {
            ...
            function warnChanges() {
                ...
                ModalModule.infoModal("Info zu Wettkampf Änderungen", "Änderungen am Wettkampf sollten vorsichtig durchgeführt werden. Den Wettkampf-Typ (z.B. Tora-Pokal) zu ändern, setzt den Wettkampf neu auf und alle bereits angemeldeten Entitäten werden zurückgesetzt.", function () {
    ...
    if (document.querySelector("main.no-tournament")) {
        ...
        createTournamentBtn.addEventListener("click", function (e) {
            ...
            ModalModule.confirmModal("Wettkampf veranstalten", content, function () {
                createTournament(content);
            }, undefined, function () {
                return checkTournamentModalContent(content);
            });
