function init(window, document, undefined) {
  ...
  let TablesModule = (function(window, document, undefined) {
    ...
    let AdminTable = function(table) {
      ...
      let Row = function (tr, tableObject) {
        ...
        function createSwitch(checked) {
          ...
          let switchContainer = Module.generateElementApi("label", ["switch-container", "input-container"]);
        ...
        function createIcon(hasRight) {
          let icon;
          if (hasRight) {
            icon = Module.generateElementApi("i", ["material-icons"], "done");
          } else {
            icon = Module.generateElementApi("i", ["material-icons"], "close");
          }
          return icon;
        }
    ...
    // if there are tables then initialize them
