  ...
  if (document.querySelector("h1 span.old-category-name")) {
    ...
    let Card = function(card) {
      ...
      this.handleSwipe = function (e) {
        ...
        let distY = e.pageY - This.swipeProperties.mouseY;
        let posX = This.swipeProperties.cardX + distX;
        let posY = This.swipeProperties.cardY + distY / 3;
    ...
    cancelBtn.addEventListener("click", function (e) {
      ...
      if (allCards.length === unassignedCards.length) {
        ...
        // TODO: Call Confirm Modal Api to ask if really want to leave page (function leavePage is positiveCallback)
      }
    });
